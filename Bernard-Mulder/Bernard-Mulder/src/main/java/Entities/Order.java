...
public class Order {
    ...
    public String toStringOrderlines(ArrayList<OrderLine> orderLines) {
        String Orderlist = orderLines.toString();
        System.out.println("String: " + Orderlist);
        return Orderlist;
    }

//    public String ToString(ArrayList<OrderLine> orderLines) {
//        String Orderlist = getOrderLines().toString(myList.toArray());
//    }
}
